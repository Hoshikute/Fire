...
namespace EGamePlay.Combat
{
    ...
    public enum ActionPointType
    {
        ...
        [LabelText("执行 伤害行动前")] PreExecuteDamage = 1 << 1,
        [LabelText("遭遇 伤害行动前")] PreSufferDamage  = 1 << 2,

        [LabelText("执行 伤害行动后")] PostExecuteDamage = 1 << 3,
        [LabelText("遭遇 伤害行动后")] PostSufferDamage  = 1 << 4,

        [LabelText("执行 治疗行动后")] PostExecuteCure = 1 << 5,
        [LabelText("遭遇 治疗行动后")] PostSufferCure  = 1 << 6,

        [LabelText("执行 赋给效果行动后")] ExecuteAssignEffect = 1 << 7,
        [LabelText("遭遇 赋给效果行动后")] SufferAssignEffect  = 1 << 8,

        [LabelText("执行 赋加状态行动后")] PostExecuteStatus = 1 << 9,
        [LabelText("遭遇 赋加状态行动后")] PostSufferStatus  = 1 << 10,

        [LabelText("给予普攻前")] PreExecuteAttack  = 1 << 11,
        [LabelText("给予普攻后")] PostExecuteAttack = 1 << 12,

        [LabelText("遭受普攻前")] PreSufferAttack  = 1 << 13,
        [LabelText("遭受普攻后")] PostSufferAttack = 1 << 14,

        [LabelText("起跳前")] PreExecuteJumpTo  = 1 << 15,
        [LabelText("起跳后")] PostExecuteJumpTo = 1 << 16,

        [LabelText("施法前")] PreExecuteSpell  = 1 << 17,
        [LabelText("施法后")] PostExecuteSpell = 1 << 18,
    ...
    public enum ApplyPointType
    {
        ...
        [LabelText("造成 伤害效果前")] PreCauseDamage   = 1 << 1,
        [LabelText("承受 伤害效果前")] PreReceiveDamage = 1 << 2,

        [LabelText("造成 伤害效果后")] PostCauseDamage   = 1 << 3,
        [LabelText("承受 伤害效果后")] PostReceiveDamage = 1 << 4,

        [LabelText("给予 治疗效果后")] PostGiveCure    = 1 << 5,
        [LabelText("接受 治疗效果后")] PostReceiveCure = 1 << 6,

        [LabelText("赋给技能效果")] AssignEffect  = 1 << 7,
        [LabelText("接受技能效果")] ReceiveEffect = 1 << 8,

        [LabelText("赋加状态后")] PostGiveStatus    = 1 << 9,
        [LabelText("承受状态后")] PostReceiveStatus = 1 << 10,

        [LabelText("给予普攻前")] PreGiveAttack  = 1 << 11,
        [LabelText("给予普攻后")] PostGiveAttack = 1 << 12,

        [LabelText("遭受普攻前")] PreReceiveAttack  = 1 << 13,
        [LabelText("遭受普攻后")] PostReceiveAttack = 1 << 14,

        [LabelText("起跳前")] PreJumpTo  = 1 << 15,
        [LabelText("起跳后")] PostJumpTo = 1 << 16,

        [LabelText("施法前")] PreSpell  = 1 << 17,
        [LabelText("施法后")] PostSpell = 1 << 18,

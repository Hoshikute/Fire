...
namespace EGamePlay.Combat
{
...
#endif
    {
        ...
        public static AbilityManagerObject Instance
        {
            get
            {
                _instance = AssetDatabase.LoadAssetAtPath<AbilityManagerObject>("Assets/AssetRaw/BattleExamples/Configs/Resources/AbilityManager.asset");
                if (_instance == null)
                {
                    _instance = new AbilityManagerObject();
                    AssetDatabase.CreateAsset(_instance, "Assets/AssetRaw/BattleExamples/Configs/Resources/AbilityManager.asset");
        ...
        public string SkillAssetFolder = "Assets/AssetRaw/BattleExamples/Configs/Resources/AbilityObjects/Skill";
        public string BuffAssetFolder = "Assets/AssetRaw/BattleExamples/Configs/Resources/AbilityObjects/Buff";
        public string ExecutionAssetFolder = "Assets/AssetRaw/BattleExamples/Configs/Resources/ExecutionObjects";

...
namespace EGamePlay
{
    public abstract partial class Entity
    {
        ...
        public T AddComponent<T>(object initData) where T : Component
        {
            ...
            if (EnableLog) 
                Log.Debug($"{GetType().Name}->AddComponent, {typeof(T).Name} initData={initData}");
        ...
        public bool TryGet<T, T1, T2>(out T component, out T1 component1, out T2 component2) where T : Component where T1 : Component where T2 : Component
        {
            ...
            if (Components.TryGetValue(typeof(T2), out var c2)) 
                component2 = c2 as T2;
            
            if (component != null && component1 != null && component2 != null) 
                return true;
        ...
        public Entity AddChild(Type entityType)
        {
            ...
            if (EnableLog) 
                Log.Debug($"AddChild {this.GetType().Name}, {entityType.Name}={entity.Id}");

...
public class MatchService : ServiceBase
{
    ...
    void StartGame(Player[] players)
    {
        ...
        EntityBase[] playerEntities = new EntityBase[players.Length];
        ...
        for (int i = 0; i < players.Length; i++)
        {
            world.eventSystem.DispatchEvent(ServiceEventDefine.c_playerJoin, playerEntities[i]);
        }
